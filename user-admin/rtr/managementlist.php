...
if (isset($_SESSION['cid'])) {
   ...
   $manages = $manage->getManagements($_SESSION['cid']);
}
?>
                  ...
                  <div class="row" style="width: 100%;align-items: center;">
                     <div class="col-lg-9 col-md-9" style="text-align: left;">
                        <div class="header-title">
                           <h4 class="card-title">Club Board Members list</h4>
                        </div>
                     </div>
                     <div class="col-md-3" style="text-align: center;">
                        <div class="header-action">
                           <i type="button" data-toggle="collapse" data-target="#datatable-1" aria-expanded="false" aria-controls="alert-1">
                              <a href="addmanagement.php" class="btn btn-outline-dark"><i class="ri-user-line"></i>&nbsp; Add Management</a>
                           </i>
                        </div>
                     </div>
                  </div>
                        ...
                        <tbody id='tbody'>
                           <?php foreach ($manages as $k => $m) : ?>
                              <tr>
                                 ...
                                 <td><a href="viewmanagement.php?uid=<?php echo $m->id ?>&">
                                    ...
                                    <a href="editmanagement.php?uid=<?php echo  $m->id ?>">
                                    ...
                                    <a href='delete.php?uid=<?php echo $m->id; ?>&cmd=management'>
