...
<div class="content-page">
                            ...
                            <div class="col-lg-12 col-md-10" style="text-align: center;">
                                ...
                                <div class="header-title">
                                    <div class="button-sub" style="text-align: center;">
                                        <button id='filter_btn' name="submit" class="btn btn-outline-dark  mt-2 btn-with-icon" style="width: 125px;">Submit</button>
                                ...
                                <tbody id='tbody'>
                                    ...
                                    <?php foreach ($projects as $key => $pro) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <!--<td><?php echo $pro->event_chairman ?></td>-->
                                            <td>
                                                <a href="editproject.php?uid=<?php echo $pro->id; ?>">
                                                    <button data-tooltip="Edit Project" class="btn btn-warning btn-xs">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                                                            <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z" />
                                                        </svg>
                                                    </button></a>
                                                <a href="viewcompleted-projects.php?uid=<?php echo $pro->id; ?>">
                                                ...
                                                <!-- <a href="completed-mail.php?id=<?php echo $pro->id; ?>">
                                                ...
                                                <?php
                                                $d1 = explode('-', $pro->post_date);
                                                $d2 = explode("-", $date);
                                                ?>

                                                <!-- <a href="addToreport.php?pid=<?php echo $pro->id; ?>&cmd=report"> -->
                                                <button data-tooltip="Add to Report" onclick='redirs(this)' data-pid="<?php echo $pro->id ?>" class="btn btn-warning btn-xs">
    ...
    <script>
        function redirs(vals) {
            var pid = vals.dataset.pid;
            if (confirm('Are you sure ? you wanna continue.')) {
                window.location.href = `./addToreport.php?cmd=report&pid=${pid}`
            } else {
                console.log('');
            }
        }
    ...
    <script>
        ...
        filter_btn.addEventListener('click', (e) => {
            ...
            const newProjects = projects.filter((p) => {
                ...
                // console.log(date[1],select_month)
                // console.log(date[0],select_year)
                // console.log(select_service,p.avenue)
            ...
            <tr>
                ...
                <td>${p.venue}</td>
                <td><a href="editproject.php?uid=${p.id}"> 
                        <button data-tooltip="Edit Project" class="btn btn-warning btn-xs">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                                <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"/>
                            </svg>
                    ...
                    <a href="viewcompleted-projects.php?uid=${p.id}"> 
                        <button data-tooltip="View Project" class="btn btn-warning btn-xs">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
                                    <path d="M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8zM1.173 8a13.133 13.133 0 0 1 1.66-2.043C4.12 4.668 5.88 3.5 8 3.5c2.12 0 3.879 1.168 5.168 2.457A13.133 13.133 0 0 1 14.828 8c-.058.087-.122.183-.195.288-.335.48-.83 1.12-1.465 1.755C11.879 11.332 10.119 12.5 8 12.5c-2.12 0-3.879-1.168-5.168-2.457A13.134 13.134 0 0 1 1.172 8z"></path>
                                    <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zM4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0z"></path>
                    ...
                    <button onclick='redirs(this)' data-pid="${p.id}" data-tooltip="Add to Report" class="btn btn-warning btn-xs">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-card-checklist" viewBox="0 0 16 16">
                            <path d="M14.5 3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5h13zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
                            <path d="M7 5.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5zm-1.496-.854a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 1 1 .708-.708l.146.147 1.146-1.147a.5.5 0 0 1 .708 0zM7 9.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5zm-1.496-.854a.5.5 0 0 1 0 .708l-1.5 1.5a.5.5 0 0 1-.708 0l-.5-.5a.5.5 0 0 1 .708-.708l.146.147 1.146-1.147a.5.5 0 0 1 .708 0z"/>
                        </svg>
