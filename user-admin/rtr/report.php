...
<div class="content-page">
    <div class="container-fluid">
                ...
                <div class="card card-block card-stretch card-height buttonDisabled" style="border-radius: 30px;">
                    <div class="card-body">
                        <div class="top-block-one text-center">
                            ...
                            <div class="mt-4">
                                <h2><b><?php echo $count['inter']; ?></b></h2>
                ...
                <div class="card card-block card-stretch card-height buttonDisabled" style="border-radius: 30px;">
                    <div class="card-body">
                        <div class="top-block-one text-center">
                            ...
                            <div class="mt-4">
                                <h2><b><?php echo $count['tot_meet']; ?></b></h2>
                ...
                <div class="card card-block card-stretch card-height buttonDisabled" style="border-radius: 30px;">
                    <div class="card-body">
                        <div class="top-block-one text-center">
                            ...
                            <div class="mt-4">
                                <h2><b><?php echo $member->getTotMember($_SESSION['cid']); ?></b></h2>
                ...
                <div class="card card-block card-stretch card-height buttonDisabled" style="border-radius: 30px;">
                    <div class="card-body">
                        <div class="top-block-one text-center">
                            ...
                            <div class="mt-4">
                                <h2><b><?php echo $count['new_memb']; ?></b></h2>
        ...
        <div class="head-title" style="margin-bottom:15px;">
            <h4 class="title-1">Joint Projects With :</h4>
        </div>
        <div class="row">
                ...
                <div class="card">
                        ...
                        <div class="row" style="width: 100%;">
                            ...
                            <div class="col-md-3" style="margin-top: 10px;text-align: center;">
                                <div class="header-action" style="margin-left: 30px">
                                    <a href="reportpdf.php" target="_blank" class="btn btn-outline-dark" style="width: 120px;"></i>Get PDF</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table id="datatable" class="table data-table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($newProjects as $key => $pro) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="delete.php?uid=<?php echo $pro->id ?>&cmd=reportPro">
                                                    <button data-tooltip="Delete" class="btn btn-warning btn-xs">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <button class="btn btn-info" onclick="submitReport()" <?php if (empty($newMeetings) && empty($newProjects)) {
                                                                                        echo "disabled";
                                                                                    } ?>> Submit Report</button>
                        </div>
                        <div class="col-md-6 mb-3" style="text-align:Right;">
                            <a href="completedreport.php" class="btn btn-info" style="margin: 10px 20px 0px 0px;">Previous Month Report</a>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    function submitReport() {
        if (confirm("Are you sure , you wanna continue")) {
            window.location.href = './projectSubmit.php';
