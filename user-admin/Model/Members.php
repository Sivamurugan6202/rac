...
class Members{
    ...
    public function addMember($data){
        $this->db->query("INSERT INTO membership(name,rid,cid,groups,dob,occupation,email,gender,doj,phone,blood,blooddonor,foodprefer,duestatus,status)
                            VAlUES(:name,:rid,:cid,:groups,:dob,:occupation,:email,:gender,:doj,:phone,:blood,:blooddonor,:foodprefer,:duestatus,:status)");
