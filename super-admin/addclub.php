                  ...
                  <form  method="POST" action=<?php echo $_SERVER['PHP_SELF']?>>
                     <div class="form-row">
                        ...
                        <div class="col-md-6 mb-3">
                           ...
                           <input type="email" class="form-control" name="cemail" id="validationTooltip02" value="abc@mail.com" required>
                           <div class="valid-tooltip">
                              Please provide a valid email
                           </div>
                        </div>                        
                        ...
                        <div class="col-md-6 mb-3">
                           ...
                           <input type="text" class="form-control" name="family_rotaract"   required >
                           <div class="valid-tooltip">
