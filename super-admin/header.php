        ...
        <div class="mm-sidebar  sidebar-default ">
            ...
            <div class="data-scrollbar" data-scroll="1">
                <nav class="mm-sidebar-menu">
                    <?php $dat['cid']='3910';$dat['name']='club';$dat['president_name']='president';?>
        ...
        <div class="mm-navbar-custom">
            <nav class="navbar navbar-expand-lg navbar-light p-0">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="navbar-nav ml-auto navbar-list align-items-center">
                        <li class="nav-item nav-icon dropdown">
                            <a class="nav-item nav-icon dropdown-toggle pr-0 search-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="assets/images/user/impact.png" class="img-fluid avatar" alt="user">
                            </a>
