               ...
               <div class="card"> 
                            ...
                            <div class="col-lg-12 col-md-10" style="text-align: center;">
                                ...
                                <div class="header-title">
                                    <div class="button-sub" style="text-align: center;">
                                        ...
                                        <button id='filter_btn' name="submit" class="btn btn-primary" onclick="reset();">Reset</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                           ...
                           <tbody id='tbody'>
                               <?php $cntc=1;?>
                                    ...
                                    <?php if($date<=$pro->post_date){continue;}?>
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <a href="projectlist.php" class="btn btn-danger" style="margin-left: 20px;">Back</a>
                    </div>
                </div>
            </div>
        </div>           
