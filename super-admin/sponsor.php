               ...
               <div class="card-header d-flex justify-content-between">
                  ...
                  <div class="header-action">
                     <i type="button" data-toggle="collapse" data-target="#datatable-1" aria-expanded="false" aria-controls="alert-1">
                        <a href="addsponsor.php" class="btn btn-outline-dark btn-add">
                        ...
                        <tbody>
                           <?php foreach ($sponsers as $key => $sponser) : ?>
                              <tr>
                                 ...
                                 <td>
                                    <img style="height:12vh;width:8vw" src="../assets/images/sponsers/<?php echo $sponser->logo; ?>" style="height=12vh;width=8vw" />
                                 </td>
