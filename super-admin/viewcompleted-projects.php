            ...
            <div class="card">
                  ...
                  <div class="table-responsive">
                     <table id="datatable" class="table data-table table-striped table-bordered" >
                        <tbody id='tbody'>
                           ...
                           <tr>
                              <th>Post Date</th>
                              <td ><?php echo isset($project->post_date)?dateFix(explode(' ',$project->pdate)[0]):"";  ?></td>
                           </tr>
                           <tr>
                              <th>Time</th>
                           ...
                           <tr>
                              ...
                              <td ><img  src="../assets/images/club_projects/<?php echo isset($project->poster_3)?$project->poster_3:"";  ?>" alt="img" width="100" ></td>
                           </tr>
                        </tbody>
                     </table>
                  </div>
               ...
               <div class="row">
                  <div class="col-md-12 mb-3">
                     <a href="completedprojectlist.php" class="btn btn-danger" style="margin-left: 20px;">Back</a>
                  </div>
               </div>                 
            </div>
         </div>
