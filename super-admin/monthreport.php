                        ...
                        <table>
                            <tbody>
                                <tr>
                                    ...
                                    <td style=' padding-left: 160px;'> :    &emsp;{$project->name}</td>
                                </tr>
                                <tr>
                                    <td style='padding-top: 5px;'> <b>Chair Name</b></td>
                                    <td style=' padding-left: 160px;padding-top: 5px;'> :  &emsp;{$project->event_chairman}</td>
                                </tr>
                                <tr>
                                    <td style='padding-top: 5px;'><b>Event Date</b></td>
                                    <td style=' padding-left: 160px;padding-top: 5px;'> :  &emsp;{$d1}</td>
                                </tr>
                                <tr>
                                    <td style='padding-top: 5px;'><b>Event Time</b></td>
                                    <td style=' padding-left: 160px;padding-top: 5px;'> :  &emsp;{$project->time}</td>
                                </tr>
                                <tr>
                                    <td style='padding-top: 5px;'><b>Avenue of Service</b></td>
                                    <td style=' padding-left: 160px;padding-top: 5px;'> :  &emsp;{$c1}</td>
                                </tr>
                                <tr>
                                    <td style='padding-top: 5px;'><b>Project with</b></td>
                                    <td style=' padding-left: 160px;padding-top: 5px;'> :  &emsp;{$pwt}</td>
                                </tr>
                                <tr>
                                    <td style='padding-top: 5px;'><b>Venue / Platform</b></td>
                                    <td style=' padding-left: 160px;padding-top: 5px;'> :  &emsp;{$project->venue}</td>
                                </tr>
                                <tr>
                                    <td style='padding-top: 5px;'><b>No.of Rotaractors</b></td>
                                    <td style=' padding-left: 160px;padding-top: 5px;'> :  &emsp;{$project->rtr_count}</td>
                                </tr>
                                 <tr>
                                    <td style='padding-top: 5px;'><b>No.of Rotarians</b></td>
                                    <td style=' padding-left: 160px;padding-top: 5px;'> :  &emsp;{$project->rtn_count}</td>
                                </tr>
                            </tbody>
                        </table>
                        <p><b>Description :</b></p>
