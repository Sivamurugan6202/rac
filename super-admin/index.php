...
<!-- Mirrored from meetmighty.com/dashboards/simpled/html/backend/auth-sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 18 Feb 2021 07:01:28 GMT -->
<head>
    <meta charset="utf-8">
      ...
      <?php echo "<script>window.location.href='./dashboard.php';</script>";?>
  <body class=" ">
    <!-- loader Start -->
    <div id="loading">
            ...
            <div class="row align-items-center justify-content-center h-100">
               <div class="col-md-5">
                  <div class="card">
                     <div class="card-body">
                        <div class="auth-logo">
                           <img src="assets/images/rtrlogo.png" class="img-fluid rounded-normal" alt="logo">
                        </div>
                        ...
                        <form>
                           ...
                           <div class="d-flex justify-content-between align-items-center">
                              <span><!-- Create an Account <a href="sigup.php" class="text-primary">Sign Up</a> --></span>
                              <a href="dashboard.php" type="submit" class="btn btn-primary">Sign In</a>
                           </div>
                        </form>
                     </div>
                  </div>
