                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">District completed Event Gallery</h4>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="datatable" class="table data-table table-striped table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>
                                            <img style="height:12vh;width:8vw" src="../assets/images/dist_events/614d7190cc4c04.04326350.jpeg">
                                        </td>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <a href="eventlist.php" class="btn btn-outline-dark">Back</a>
                        </div>
