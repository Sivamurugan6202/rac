...
class Event
{
    ...
    public function addEvent($data)
    {
        ...
        $this->db->query("INSERT INTO dist_event
                            (name,xiv_rotaract,date,time,venue,map_location,event_chairman,event_secretary,host_club,host_chairman,host_secretary,host_conveyer,email,phone,description,banner)
                            VALUES(:name,:xiv_rotaract,:date,:time,:venue,:map_location,:event_chairman,:event_secretary,:host_Club,:host_chairman,:host_secretary,:host_conveyer,:email,:phone,:description,:banner)");
