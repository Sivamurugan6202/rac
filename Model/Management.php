...
class Management{
    ...
    public function getManagementsWCid($cid){
        $this->db->query("SELECT membership.* , club_management.* FROM membership JOIN club_management ON membership.cid=club_management.cid WHERE club_management.cid=:cid AND club_management.rid=membership.rid ORDER BY pdate ASC ");
